...
export default function CardFooterChart({
  bigChartData,
  setBgChartData,
  classNames,
}) {
      ...
      <Row>
        <Col sm="6">
          ...
          >
            <Button
              tag="label"
              className={classNames("btn-simple", style.week_chart_btn, {
        ...
        <Col
          sm="6"
          className={`d-none d-sm-block d-md-block d-lg-block d-xl-block text-right pr-sm-5 pt-sm-2 ${style.dir_left}`}
        >
          <span
            style={{
